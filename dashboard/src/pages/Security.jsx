        ...
        <div className="max-w-[800px] mx-auto px-8">
          ...
          <div className="space-y-12">
            ...
            <div>
              ...
              <p className="text-[#586464] leading-relaxed mb-4">
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm text-[#586464] font-medium">
            ...
            <div>
              ...
              <p className="text-[#586464] leading-relaxed">
