...
const SEO = {
  ...
  description: 'Track traffic, leads, and revenue from ChatGPT, Claude, Gemini, Perplexity, and 15 AI platforms. Stop losing AI referrals to direct traffic in your attribution reports.',
