        ...
        <div className="max-w-[1320px] mx-auto px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <article key={i} className="relative overflow-hidden p-7 rounded-[28px] bg-white border border-[rgba(18,16,12,.10)] shadow-[0_12px_38px_rgba(18,16,12,.055)] min-h-[220px]">
                <div className="absolute right-[-48px] bottom-[-48px] w-[158px] h-[158px] rounded-full bg-[rgba(210,236,42,.18)]" />
                ...
                <p className="relative z-10 mt-3 text-[#6E675C] text-base leading-[1.55]">{f.body}</p>
              </article>
            ))}
          </div>
        </div>
      ...
      <section className="py-[96px] bg-[#F7F4ED] border-b border-[rgba(18,16,12,.06)]">
        <div className="max-w-[1320px] mx-auto px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 rounded-2xl bg-white border border-[rgba(18,16,12,.06)]">
              <strong className="text-st-black text-lg tracking-tight block mb-2">Referring Domain Lists</strong>
              <p className="text-[#6E675C] text-sm leading-relaxed">
      ...
      <section className="py-[96px] bg-white">
        <div className="max-w-[1320px] mx-auto px-8">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-7">
            <div className="rounded-[36px] p-[48px] bg-st-black text-white border border-white/10 shadow-[0_24px_80px_rgba(18,16,12,.12)]">
              ...
              <p className="mt-4 text-[#D6CDBB] text-base leading-[1.55]">
              ...
              <Link to="/report-builder" className="mt-6 inline-flex items-center justify-center gap-2.5 min-h-[52px] px-[22px] rounded-full bg-st-lime text-st-black text-[15px] font-extrabold tracking-[-0.025em] shadow-[0_18px_52px_rgba(210,236,42,0.28)] hover:bg-[#BCD41C] transition-all hover:-translate-y-px">
                Build an AI tracking report
              </Link>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col p-6 rounded-[26px] bg-[#F7F4ED] border border-[rgba(18,16,12,.10)] shadow-[0_12px_38px_rgba(18,16,12,.055)] min-h-[140px]">
                <strong className="text-lg tracking-[-0.04em]">15 AI platforms</strong>
                <p className="mt-1.5 text-[#6E675C] text-[15px]">ChatGPT, Claude, Gemini, Perplexity, and 11 more — each tracked as a distinct referral source.</p>
              </div>
              <div className="flex flex-col p-6 rounded-[26px] bg-white border border-[rgba(18,16,12,.12)] shadow-[0_12px_38px_rgba(18,16,12,.055)] min-h-[140px]">
                <strong className="text-lg tracking-[-0.04em]">Full journey tracking</strong>
                <p className="mt-1.5 text-[#6E675C] text-[15px]">See which pages AI-referred visitors land on and every touchpoint before they convert.</p>
              </div>
              <div className="flex flex-col p-6 rounded-[26px] bg-white border border-[rgba(18,16,12,.12)] shadow-[0_12px_38px_rgba(18,16,12,.055)] min-h-[140px]">
                <strong className="text-lg tracking-[-0.04em]">Conversion & revenue attribution</strong>
                <p className="mt-1.5 text-[#6E675C] text-[15px]">Attribute leads, trials, purchases, and revenue to the AI platform that started the journey.</p>
              </div>
              <div className="flex flex-col p-6 rounded-[26px] bg-white border border-[rgba(18,16,12,.12)] shadow-[0_12px_38px_rgba(18,16,12,.055)] min-h-[140px]">
                <strong className="text-lg tracking-[-0.04em]">Channel comparison</strong>
                <p className="mt-1.5 text-[#6E675C] text-[15px]">Compare AI-driven conversion quality against paid, organic, social, email, and partner channels.</p>
              </div>
              <div className="flex flex-col p-6 rounded-[26px] bg-white border border-[rgba(18,16,12,.12)] shadow-[0_12px_38px_rgba(18,16,12,.055)] min-h-[140px]">
                <strong className="text-lg tracking-[-0.04em]">AI trend reporting</strong>
                <p className="mt-1.5 text-[#6E675C] text-[15px]">Track AI referral growth over time. See which platforms are gaining share as an acquisition channel.</p>
              </div>
              <div className="flex flex-col p-6 rounded-[26px] bg-white border border-[rgba(18,16,12,.12)] shadow-[0_12px_38px_rgba(18,16,12,.055)] min-h-[140px]">
                <strong className="text-lg tracking-[-0.04em]">One snippet — no extra setup</strong>
                <p className="mt-1.5 text-[#6E675C] text-[15px]">The same lightweight tracker detects AI platforms automatically. No extra script, no extra config.</p>
              </div>
            </div>
          </div>
        </div>
