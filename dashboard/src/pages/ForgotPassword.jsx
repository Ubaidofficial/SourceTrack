          ...
          {success ? (
            <div className="space-y-4">
              ...
              <p className="text-center text-sm text-st-gray">
                Done? <Link to="/login" className="text-st-black dark:text-white hover:underline">Back to sign in</Link>
              </p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <p className="text-center text-sm text-st-gray">
                Remember your password? <Link to="/login" className="text-st-black dark:text-white hover:underline">Sign in</Link>
              </p>
            </form>
          )}
        </div>
