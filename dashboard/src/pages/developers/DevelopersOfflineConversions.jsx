      ...
      <div className="space-y-6">
        ...
        <section className="space-y-4">
          ...
          <ParamTable params={[
            ...
            { name: 'anonymous_id', type: 'string', required: false, requiredCondition: 'conditionally required', desc: 'The visitor\'s anonymous st_aid identifier. Required if user_id is omitted.' },
            { name: 'user_id', type: 'string', required: false, requiredCondition: 'conditionally required', desc: 'The user database identifier on your backend. Required if anonymous_id is omitted.' },
