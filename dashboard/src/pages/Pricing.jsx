        ...
        <div className="max-w-[1320px] mx-auto px-8 text-center">
          ...
          <div className="mt-[54px]">
            <FAQSection faqs={[
              ...
              { q: 'How does the free plan work?', a: 'Free forever — see where your next 30 conversion source profiles came from. Includes 1 site, 5,000 tracked pageviews/mo, simple analytics, traffic sources, top pages, referrers, countries, devices, browsers, UTMs, AI source detection, and basic conversion source profiles. CSV export, saved reports, dashboard widgets, manual revenue/status, API/webhooks, and revenue attribution are available on paid plans.' },
