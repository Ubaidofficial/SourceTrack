...
export default function OnboardingCard({ icon: Icon, title, subtitle, children, onBack, showBack = false }) {
  return (
    <div className="w-full max-w-[650px] rounded-[20px] border border-[#DDE4E4] dark:border-white/10 bg-white dark:bg-[#1A1F1F] shadow-[0_18px_50px_rgba(18,16,12,0.10)] dark:shadow-none p-8">
      <div className="flex items-start gap-4 mb-6">
        <div className="h-14 w-14 shrink-0 rounded-full bg-[#F1F4F4] dark:bg-white/5 flex items-center justify-center text-[#12100C] dark:text-dark-primary">
