...
export default function MarketingFooter() {
  return (
    <footer className="py-[42px] bg-st-black text-[#D6CDBB] border-t border-white/10">
      <div className="max-w-[1320px] mx-auto px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1fr_1fr] gap-7">
          <div>
            ...
            <p className="mt-[18px] max-w-[340px] text-sm leading-relaxed text-[#D6CDBB]">
        ...
        <div className="mt-[30px] pt-[22px] border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-5 text-[13px] text-[#A39B8C]">
