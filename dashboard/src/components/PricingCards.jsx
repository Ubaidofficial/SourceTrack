...
// annual) maps to Growth entitlements (api/routes/billing.js:25), so 1,000,000.
//
...
// and the card under-promised Growth by ~6.7x for as long as it stood. If you change a
// number here, re-read plan-features.js in the SAME edit — this comment is only true
// while someone keeps making it true.
//
