...
export default function HeroSection({
  ...
  secondaryCta,
  secondaryHref,
  proofs = ['Install in minutes', 'No credit card required', 'Built for founders and marketers'],
  children,
}) {
  return (
      ...
      <div className="relative z-10 max-w-[1320px] mx-auto px-8">
        <div className="grid grid-cols-12 gap-6">
          <div className="col-span-12 lg:col-span-6 self-center">
            {kicker && (
              <span className="inline-flex items-center gap-2 rounded-full py-2 px-3 text-[13px] font-extrabold tracking-[-0.015em] text-st-black bg-[rgba(18,16,12,.055)] border border-[rgba(18,16,12,.07)]">
            ...
            <h1 className="mt-[18px] max-w-[880px] text-st-black leading-[0.88] tracking-[-0.08em] font-black" style={{ fontSize: 'clamp(40px, 7.3vw, 104px)' }}>
              {h1}{' '}
              {h1Gradient && (
                <span className="bg-clip-text text-transparent" style={{ backgroundImage: 'linear-gradient(90deg, #12100C, #4E5A23 50%, #9FC20C)' }}>
                  {h1Gradient}
                </span>
              )}
            </h1>
