...
// 3-stop vertical gradient: solid #D2EC2A at the top → 18% mid → transparent at
...
export function limeAreaGradient(ctx) {
  ...
  if (!chartArea) return 'rgba(210,236,42,0.18)'
  const g = canvas.createLinearGradient(0, chartArea.top, 0, chartArea.bottom)
  g.addColorStop(0, '#D2EC2A')
  g.addColorStop(0.5, 'rgba(210,236,42,0.18)')
  g.addColorStop(1, 'rgba(210,236,42,0)')
  return g
}
