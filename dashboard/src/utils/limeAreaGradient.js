...
// 3-stop vertical gradient: solid #C8F000 at the top → 18% mid → transparent at
...
export function limeAreaGradient(ctx) {
  ...
  if (!chartArea) return 'rgba(200,240,0,0.18)'
  const g = canvas.createLinearGradient(0, chartArea.top, 0, chartArea.bottom)
  g.addColorStop(0, '#C8F000')
  g.addColorStop(0.5, 'rgba(200,240,0,0.18)')
  g.addColorStop(1, 'rgba(200,240,0,0)')
  return g
}
