  ...
  try {
    ...
    const sql = `
      SELECT
        ...
        properties.ref_param AS ref_param,
        properties.source_param AS source_param,
        properties.via_param AS via_param,
        ...
        properties.utm_id AS utm_id,
        properties.st_campaign_id AS st_campaign_id,
        properties.st_adgroup_id AS st_adgroup_id,
        properties.st_ad_id AS st_ad_id,
        properties.st_target_id AS st_target_id,
        properties.st_network AS st_network,
        properties.st_device AS st_device,
        properties.st_matchtype AS st_matchtype,
    ...
    const events = rows.map(([
      ...
      gbraid, wbraid, li_fat_id, li_fatid, twclid, dclid, snapclid, pclid, sccid, ko_click_id,
      utmId, stCampaignId, stAdgroupId, stAdId, stTargetId,
      stNetwork, stDevice, stMatchtype,
      rawProperties
    ]) => ({
      event,
      timestamp,
      ...
      utm_id: utmId || null,
      st_campaign_id: stCampaignId || null,
      st_adgroup_id: stAdgroupId || null,
      st_ad_id: stAdId || null,
      st_target_id: stTargetId || null,
      st_network: stNetwork || null,
      st_device: stDevice || null,
      st_matchtype: stMatchtype || null,
