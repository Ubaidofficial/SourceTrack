...
// 'pro' and 'agency' are legacy aliases; mapped here for backwards compat.
...
// Default monthly pageview limits per plan tier.
...
export const PLAN_STRUCTURAL_LIMITS = {
  free:     { sites: 1,        webhooks: 1, team_members: 1,  retention_days: 30,   conversion_events: 1 },
  trial:    { sites: 1,        webhooks: 5, team_members: 1,  retention_days: 365,  conversion_events: 99 },
  starter:  { sites: 1,        webhooks: 5, team_members: 1,  retention_days: 365,  conversion_events: 99 },
  growth:   { sites: 5,        webhooks: 20,team_members: 5,  retention_days: 1095, conversion_events: 99 },
  business: { sites: Infinity, webhooks: 99,team_members: 99, retention_days: 1825, conversion_events: 99 },
