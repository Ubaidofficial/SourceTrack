...
if (!BASE_URL || !SITE_KEY) {
  throw new Error('BASE_URL and SITE_KEY must be provided as environment variables! e.g., k6 run -e BASE_URL=http://localhost:3000 -e SITE_KEY=st_test_key scripts/load/k6-track.js');
}
...
export default function () {
  ...
  const payload = JSON.stringify({
    ...
    page_url: 'http://example.com/k6-test-page',
