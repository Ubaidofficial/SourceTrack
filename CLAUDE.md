...
- **Orchestrator (planning chat)** — plans, dispatches, verifies. Read-only MCP: **Supabase + PostHog (PROD project 416017 only) + Railway + Tinybird + GitHub**. Reviews SQL and hand-applies migrations on human go. Does not write code.
