...
test('every --live target loader resolves to a drivable shape (handlerFn OR callFn) + seams', async () => {
  ...
  assert.deepStrictEqual(names.sort(), ['ai-platform', 'alerts', 'events-health', 'explain', 'first-touch', 'first-touch-non-direct', 'flexible-report', 'flexible-report-provider', 'last-touch', 'last-touch-non-direct', 'multitouch', 'session-report', 'session-report-filtered', 'sessions'], 'expected exactly these fourteen targets')
